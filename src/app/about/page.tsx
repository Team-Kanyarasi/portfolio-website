...
import { baseURL, about, team, social } from "@/resources";
  ...
  return (
    <Column maxWidth="m">
      ...
      <Flex fillWidth mobileDirection="column" horizontal="center">
        {/* Removed about.avatar.display section as it's false in content.js */}
        <Column className={styles.blockAlign} flex={9} maxWidth={40}>
          ...
          >
            ...
            <Heading className={styles.textAlign} variant="display-strong-xl">
              {about.intro.title} {/* Changed from person.name */}
            </Heading>
            <Text
            ...
            >
              {about.description} {/* Changed from person.role */}
            </Text>
            {social.length > 0 && (
